...
if (isset($_POST['name'])) {
    ...
    $valid_cover = validateImage('cover', '../images/destinations/');

    if ($valid_cover) {
        // add record
        if ($_GET['operation'] == 'add') {
            $query = 'INSERT INTO DESTINATIONS (CATEGORY_ID, NAME, DESCRIPTION, COVER) VALUES ('
                . '"' . $_GET['category']        . '", '
                . '"' . $_POST['name']           . '", '
                . '"' . $_POST['description']    . '", '
        ...
        if ($_GET['operation'] == 'update') {
            ...
            $query = 'SELECT * FROM DESTINATIONS WHERE ID=' . $_GET['id'];
        ...
        <div class="container">
            ...
            <div class="wrapper">
                <div id="formContent">
                    ...
                    <a href=<?php echo "home.php?category=" . $_GET['category'] ?>>Back</a>
                </div>
            </div>
        </div>
    </section>
